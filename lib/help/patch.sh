...
show_patch_help() {
    ...
    echo -e "  $0 patch <patchfile> [options]\n"
    ...
    echo -e "  $0 patch changes.patch"
    echo -e "  $0 patch changes.patch -i"
    echo -e "  $0 patch git.patch -- -3"
    echo -e "  $0 patch hg.patch -- -f"
}
...
show_git_patch_help() {
    echo -e "${LTBLUE}${BOLD}Patchouli${RESET} - ${BOLD}patch${RESET}\n"
    echo -e "${YELLOW}${BOLD}Usage:${RESET}"
    echo -e "  $0 patch <patchfile> [options] # In a Git repository\n"
    ...
    echo -e "${YELLOW}${BOLD}Examples:${RESET}"
    echo -e "  $0 patch git.patch       # Standard apply"
    echo -e "  $0 patch git.patch -3    # With 3-way merge"
    echo -e "  $0 patch git.patch -i    # Interactive mode"
}

show_hg_patch_help() {
    echo -e "${LTBLUE}${BOLD}Patchouli${RESET} - ${BOLD}patch${RESET}\n"
    echo -e "${YELLOW}${BOLD}Usage:${RESET}"
    echo -e "  $0 patch <patchfile> [options] # In a Mercurial repository\n"
    ...
    echo -e "${YELLOW}${BOLD}Examples:${RESET}"
    echo -e "  $0 patch hg.patch       # Standard import"
    echo -e "  $0 patch hg.patch -f    # Force import"
}
